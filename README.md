...
| Day | Python Topic Learned | Problems Solved |
| :--- | :--- | :--- |
...
├── day007/
│   ├── abstraction.py
│   ├── earliest_finish_for_land_and_water_rides.py
│   ├── minimum_cost_of_buying_candles_with_discount.py
│   ├── palindrome.py
│   ├── remove_element.py
│   └── square_root.py
├── day008/
│   ├── ealiest_finish_for_land_and_water_rides_2.py
│   ├── file_handling.py
│   ├── rotate_image.py
